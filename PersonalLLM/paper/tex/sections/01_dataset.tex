...
% \hntodo{To motivate the seemingly contrived simulation approach, it'll be helpful to have a couple of sentences that serve as a prelude to the comparison results to come. We can explicitly say simulating diversity is challenging and as we demonstrate our ensemble approach addresses the challenges.}
...
% (we validate this hypothesis in Section~\ref{sec:persona_analysis}).
...
% \hntodo{Mention the simulated reward papers from RL again to say this approach is standard.}
